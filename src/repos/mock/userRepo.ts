...
const data: User[] = [
  { id: 'u0', email: 'super@acme.com', name: 'Super Admin', role: 'super_admin', companyId: 'c1', avatarUrl: SAMPLE_AVATARS.u0, lastSeen: 'online' },
  { id: 'u1', email: 'admin@acme.com', name: 'Admin User', role: 'company_admin', companyId: 'c1', avatarUrl: SAMPLE_AVATARS.u1, lastSeen: new Date(Date.now() - 5 * 60000).toISOString() },
  { id: 'u2', email: 'lead@acme.com', name: 'Jane Lead', role: 'project_lead', companyId: 'c1', avatarUrl: SAMPLE_AVATARS.u2, lastSeen: 'online' },
  { id: 'u3', email: 'consultant@acme.com', name: 'Bob Consultant', role: 'consultant', companyId: 'c1', lastSeen: new Date(Date.now() - 2 * 3600000).toISOString() },
  { id: 'u4', email: 'alice@acme.com', name: 'Alice Dev', role: 'consultant', companyId: 'c1', lastSeen: new Date(Date.now() - 24 * 3600000).toISOString() },
]
